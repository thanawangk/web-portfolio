...
export function MailButton({
  ...
  return (
    <a
      href={`mailto:${email}`}
      className={`group relative inline-flex max-w-full items-center justify-center gap-1.5 overflow-hidden rounded-3xl border-[3px] border-on-accent bg-accent px-3 py-[11px] text-xs font-bold whitespace-nowrap text-on-accent sm:px-5 sm:text-lg md:px-6 md:py-[13px] lg:px-8 [box-shadow:5px_5px_0_var(--color-on-accent)] [transition:translate_0.3s_cubic-bezier(0.34,1.56,0.64,1),box-shadow_0.3s_ease,background-color_0.3s_ease] hover:translate-x-[2px] hover:translate-y-[2px] hover:bg-accent-hover hover:text-on-accent hover:[box-shadow:2px_2px_0_var(--color-on-accent)] ${className}`}
    >
