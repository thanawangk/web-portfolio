...
export function ContactSection() {
  return (
    ...
    >
      <div className="relative mx-auto max-w-[920px] rounded-[36px] border-[3px] border-border-strong bg-surface px-6 pt-11 pb-[2px] text-center md:px-10 md:pt-14 lg:px-12 lg:pt-18 shadow-(--shadow-offset-card) transition-[translate,scale,box-shadow,border-color] duration-300 ease-[var(--ease-spring),var(--ease-spring),var(--ease-spring),ease] hover:translate-x-[-6px] hover:translate-y-[-10px] hover:scale-[1.015] hover:border-accent hover:shadow-(--shadow-offset-card-hover)">
